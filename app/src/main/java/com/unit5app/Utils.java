...
public class Utils {
    ...
    /**
     * Returns today's date without leading zeroes in the format "MM/dd/yy".
     * @return a String representing today's date based on the format "MM/dd/yy".
     */
    public static String getCurrentDate() {
        return getCurrentDate("MM/dd/yy");
    }
